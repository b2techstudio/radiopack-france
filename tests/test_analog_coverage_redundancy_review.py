...
assert normandie["schema_version"] == "1.2"
...
assert "manuel.la-radio.eu" in source_authorities
...
print("Tests analog coverage/redundancy review: Bretagne 432.650 linkage remains unverified, Rennes operator-vs-directory status conflicts reconciled conservatively, Normandie F1ZBL source-agreed and F5ZHA independently corroborated but local-publication block retained, no public mutation OK")
