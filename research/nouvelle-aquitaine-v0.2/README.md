# Nouvelle-Aquitaine v0.2

Cette version enrichit la v0.1 sans la modifier. Le pack public courant contient **151 mémoires RX**.
...
- 6 APRS / ISS ;
- 13 mémoires aviation AM revues dans le contexte SIA AIRAC 08/26 ;
- 12 relais FM 2 m sélectionnés, soit 24 mémoires paired RX ;
