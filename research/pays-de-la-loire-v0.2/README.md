# Pays de la Loire v0.2

Cette version enrichit la v0.1 sans la modifier. Le pack public courant contient **130 mémoires RX**.
...
- 6 APRS / ISS ;
- 10 mémoires aviation AM revues dans le contexte SIA AIRAC 08/26 ;
