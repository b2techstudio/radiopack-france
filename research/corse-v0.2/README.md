...
Cette version enrichit la v0.1 sans la modifier. Le pack public courant contient **137 mémoires RX**.
...
- 6 APRS / ISS ;
- 19 mémoires aviation AM revues dans le contexte SIA AIRAC 08/26 ;
- 2 relais FM 2 m sélectionnés, soit 4 mémoires paired RX ;
