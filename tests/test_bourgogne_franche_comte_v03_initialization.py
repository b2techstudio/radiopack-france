...
# The research initialization baseline remains immutable even after v0.3 publication.
...
# The initial current-directory audit remains a zero-delta historical record.
...
print("BFC v0.3 initialization baseline preserved after publication: v0.2=37 immutable, v0.3=54 immutable, 10 original analog leads retained, OK")
