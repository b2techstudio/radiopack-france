...
# Shared crossband RF is represented once after deduplication.
...
assert manifest["aviation_publication_gate_complete"] is False
assert manifest["review_checklist_complete"] is False
assert manifest["publication_gates_zero_blockers"] is False
...
print("Sprint 102 Grand Est v0.3 deterministic candidate: 84 RX / 19 aviation / 41 regional, SHA frozen, public=false OK")
