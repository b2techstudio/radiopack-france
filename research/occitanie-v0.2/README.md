...
Cette version enrichit la v0.1 sans la modifier. Le pack public courant contient **156 mémoires RX**.
...
- 6 APRS / ISS ;
- 20 mémoires aviation AM revues dans le contexte SIA AIRAC 08/26 ;
- 11 relais FM 2 m sélectionnés, soit 22 mémoires paired RX ;
