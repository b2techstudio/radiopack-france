...
assert "Sprint courant : **65**" in status_text
assert "État logique : **0.21.54**" in status_text
...
assert "Sprint 65" in status_text
...
print(
    ...
    "non-public, recovery state is self-contained at sprint 65, OK"
)
