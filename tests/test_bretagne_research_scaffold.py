...
assert set(north_summary["site_names_partially_revalidated"]) == {"Cap Fréhel", "Stiff / Ouessant"}
...
coverage = north["current_operational_coverage_evidence"]
...
assert maritime["repeaters"]["maritime_remote_sites"]["status"] == "etel_weather_emitters_partial_inventory_corsen_two_radio_infrastructures_and_sector_coverage_verified_channelled_inventory_required"
...
assert emergency["schema_version"] == "1.4"
...
assert emergency_candidates["F5ZZH"]["output_mhz"] == 145.7875
assert emergency_candidates["F5ZZH"]["input_mhz"] == 145.1875
assert emergency_candidates["F5ZZH"]["rx_pack_candidate"] is False
...
assert emergency["rules"]["temporarily_stopped_repeaters_not_active_candidates"] is True
