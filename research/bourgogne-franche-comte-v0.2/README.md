# Bourgogne-Franche-Comté v0.2

Cette version enrichit la v0.1 sans la modifier. Le pack public courant contient **37 mémoires RX**.
...
- 6 APRS / ISS ;
- 7 mémoires aviation AM revues dans le contexte SIA AIRAC 08/26 ;
- 3 relais FM 2 m sélectionnés, soit 6 mémoires paired RX ;
- VHF marine non intégrée à ce pack intérieur.
