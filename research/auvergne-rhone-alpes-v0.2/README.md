# Auvergne-Rhône-Alpes v0.2

Cette version enrichit la v0.1 sans la modifier. Le pack public courant contient **62 mémoires RX**.
...
- 6 APRS / ISS ;
- 18 mémoires aviation AM revues dans le contexte SIA AIRAC 08/26 ;
- 10 relais FM 2 m sélectionnés, soit 20 mémoires paired RX ;
