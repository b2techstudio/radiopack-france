...
assert resume["current_sprint"] == 34
assert resume["state_version"] == "0.21.23"
...
assert "Sprint courant : **34**" in status_text
...
print(
    ...
    "non-public, recovery state is self-contained, OK"
)
