...
export const metropolitanPackDefinitions: MetropolitanPackDefinition[] = [
  {
    ...
    aviation: [
      ...
      { name: "LIL-ATIS", frequency: 119.33, area: "Lille", service: "ATIS", icao: "LFQQ" },
  ...
  },
  {
    ...
    aviation: [
      { name: "AIR-EMERG", frequency: 121.5, area: "France / aviation", service: "EMERGENCY" },
      { name: "SXB-FIS1", frequency: 119.58, area: "Strasbourg", service: "FIS", icao: "LFST" },
      ...
      { name: "MLH-FIS1", frequency: 129.25, area: "Bâle-Mulhouse", service: "FIS", icao: "LFSB" },
      { name: "MLH-FIS2", frequency: 130.9, area: "Bâle-Mulhouse", service: "FIS", icao: "LFSB" },
      { name: "MLH-FIS3", frequency: 134.68, area: "Bâle-Mulhouse", service: "FIS", icao: "LFSB" },
      { name: "MLH-APP1", frequency: 125.16, area: "Bâle-Mulhouse", service: "APP", icao: "LFSB" },
      ...
      { name: "ETZ-ATIS", frequency: 136.58, area: "Metz-Nancy", service: "ATIS", icao: "LFJL" },
