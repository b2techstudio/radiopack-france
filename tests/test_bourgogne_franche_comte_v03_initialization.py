...
assert backlog["candidate_memory_delta"] == 0
...
assert all(item["state"] == "current_ref_active_second_source_required" for item in backlog["items"])
...
print("Bourgogne-Franche-Comté v0.3 initialized from immutable v0.2=37; 10 analog leads / potential +20 remain unpromoted, OK")
