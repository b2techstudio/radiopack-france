# Centre-Val de Loire v0.2

Cette version enrichit la v0.1 sans la modifier. Le pack public courant contient **42 mémoires RX**.
...
- 6 APRS / ISS ;
- 6 mémoires aviation AM revues dans le contexte SIA AIRAC 08/26 ;
- 6 relais FM 2 m sélectionnés, soit 12 mémoires paired RX ;
